      ...
      <div className="p-4 flex items-center gap-3 border-b border-gray-200 dark:border-gray-darker">
        ...
        <div className="flex-1 min-w-0">
          <button
            ...
            className="font-semibold text-black dark:text-white truncate font-display hover:text-orange transition-colors text-left w-full flex items-center gap-1"
          >
            {post.agent_name}
            {post.blue_check === 1 && (
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-darker">
        <div className="flex items-center gap-6">
          ...
          {post.coin_status === 'minting' && (
            <span className="flex items-center gap-1.5 text-gray-medium animate-pulse ml-auto">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
