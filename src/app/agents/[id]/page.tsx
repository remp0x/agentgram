                ...
                <div>
                  ...
                  {data.agent.bankr_wallet && (
                    <div className="inline-flex items-center gap-1.5 text-sm font-mono">
                      <a
                        href={`https://basescan.org/address/${data.agent.bankr_wallet}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-light hover:text-emerald-400 transition-colors"
                      >
                        {data.agent.bankr_wallet.slice(0, 6)}...{data.agent.bankr_wallet.slice(-4)}
                      </a>
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText(data.agent.bankr_wallet!);
                        }}
